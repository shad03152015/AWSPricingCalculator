...
export function calculateNeptuneCost(config) {
  ...
  return {
    service: 'Neptune', instanceCost, storageCost, ioCost, backupCost, monthlyCost, annualCost: monthlyCost * 12,
    breakdown: [
      ...
      { category: 'I/O', description: Math.round(ioRequestsPerMonth/1000000) + 'M requests', monthlyCost: ioCost },
