...
import { DOCUMENTDB_INSTANCE_TYPES, calculateNeptuneCost } from '../../data/neptuneData';

const NeptuneConfigForm = ({ onRemove, onCostUpdate }) => {
  ...
  useEffect(() => {
    const calculatedCost = calculateNeptuneCost(config);
    ...
    <Paper elevation={3} sx={{ p: 3, mb: 3 }}>
      <Box display="flex" justifyContent="space-between" alignItems="center" mb={3}>
        <Box display="flex" alignItems="center" gap={2}>
          <Typography variant="h5" fontWeight="bold" color="primary">Neptune Configuration</Typography>
          <Chip label="Graph DB" color="success" size="small" />
        </Box>
...
export default NeptuneConfigForm;
